...
public class EditListingFragment extends Fragment {
    ...
    public static EditListingFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Save ska uppdatera informationen i databasen men också ta en tillbaka till ListingFragment (Toast i onResponse)
